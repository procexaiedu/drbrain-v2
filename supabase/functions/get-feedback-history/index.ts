...
console.log('Function get-feedback-history loaded');
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    if (error) {
      console.error('Erro ao buscar histórico do Agente de Feedback:', error);
    ...
    console.error('Erro na Edge Function get-feedback-history:', error);
